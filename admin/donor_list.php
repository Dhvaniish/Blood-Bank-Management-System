      ...
      <table class="table table-bordered" style="text-align:center">
          ...
          <tr>
                  ...
                  <td id="he" style="width:100px">
                    <a style="text-align: center;" href='delete.php?id=<?php echo $row['donor_id']; ?>'> Delete </a>
                  </td>
                  <td id="he" style="width:100px">
                    <a style="text-align: center;" href='mailer.php?id=<?php echo $row['donor_mail']; ?>'> Verify </a>
                  </td>
              </tr>
            <?php } ?>
          </tbody>
