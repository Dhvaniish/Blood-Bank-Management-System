...
<nav class="navbar navbar-inverse" style="border-radius:0px; font-family: 'Nunito', sans-serif;">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" id="qq" href="dashboard.php" style="color:#F51A14; font-family: 'Poppins', sans-serif;">Blood Bank & Donation Admin Panel</a>
    </div>
      ...
      <li class="dropdown"><a class="dropdown-toggle" id="qw" data-toggle="dropdown" href="#" style="font-weight:bold;color:white "> <span class="glyphicon glyphicon-user"></span>&nbsp&nbsp
       ...
       ?><span class="caret"></span></a>
        <ul class="dropdown-menu" style="background-color:#D6EAF8;">
          <li><a href="change_password.php" style="color:#DC7633; font-family: 'Nunito', sans-serif; ">Change Password </a></li>
          <li><a href="logout.php" style="color:#D35400 ; font-family: 'Nunito', sans-serif;">Logout</a></li>
        </ul>
    </li>
    </ul>
